 ...
 */
#ifndef DUMUX_HTUBE_SUBPROBLEM_HH
#define DUMUX_HTUBE_SUBPROBLEM_HH
...
class HTubeSubProblem : public PorousMediumFlowProblem<TypeTag>
{
...
public:
    HTubeSubProblem(std::shared_ptr<const GridGeometry> gridGeometry,
    ...
    {
        //2pinfiltration
        initialValues_ = readFileToContainer<std::vector<PrimaryVariables>>("htubeinitialsolutioncc.txt");
        //test1p2p
        problemName_  =  getParam<std::string>("Vtk.OutputName") + "_" + getParamFromGroup<std::string>(paramGroup, "Problem.Name");
        //ex_ff_pm
        P_ = getParamFromGroup<Scalar>(paramGroup, "Problem.BoundaryPressure");
        delta_ = getParamFromGroup<Scalar>(paramGroup, "Problem.Delta");
    }
    ...
    BoundaryTypes boundaryTypes(const Element &element, const SubControlVolumeFace &scvf) const
    {
        ...
        // set Dirichlet BCs to the side-boundaries
